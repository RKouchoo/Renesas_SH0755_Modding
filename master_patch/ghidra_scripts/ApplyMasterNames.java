...
public class ApplyMasterNames extends GhidraScript {
    ...
    public void run() throws Exception {
        setPlateComment(toAddr("0000b62a"),
            "Current master WB publication parent: acquire3AF4 mask90 atB632 fromliteralB66C=0090; save prior mask on stack; updateAED0 counter; callB690 (patched to7E440); reload prior mask and tail3B08. Thus the eight scalar publications run within the native task/IRQ-priority lock, not as an unprotected main-task sequence. Interrupt priorities above9 remain possible. Does not consume the replaced processor's R0/FR0 return.\n\n2026-09-13 paired stock/v2 workload: after nativeB49A initialization, explicit AED0=0/255 and ADC=0/30000/65535 yield stock401/564 versus v2 57..82 executed instructions at IMASK9. V2 mask9 section contains noFDIV. Caller mask2 is supplied so final unlock does not enter task dispatch; this is not a measured operating caller mask. No timer/elapsed-time/whole-scheduler conclusion. See analyze_20260913_patch_workload.py.");
        setPlateComment(toAddr("000172a4"),
            "2026-09-13 full-process audit: Both current main and v2, including captured fd7958 v2, replace pointer 173FC with 27088 (zero MAF-fault result) and 1743C with 7E18C. Full native task tested: snapshots old B458/B45C to B414/B418 and B448 to synthetic histories, computes old IAT/airflow corrections B44C/B450 before SD replaces result, then raw B428 and stock .06 B42C -> B438 filters use the same entry RPM in FR15. Stale/nonfinite old histories do not replace final SD in value fixtures. B748/80 selects ECT initial load; B52C/80 drives separate 1785C reset. See tests/test_airflow_task_process_flow.py; no scheduler/FPU-latency proof or cut diagnosis.\n\n2026-09-13 paired native stock/v2 workload:72 RPM2500..4144/lift1,3/MAP300,760,810 fixtures, IAT37/ECT61/prior airflow105. Complete task executes382..494 more instructions in v2 with supplied incoming IMASK0 preserved throughout. At3152/high/810:stock938 versusv2 1403, FDIV7 versus10, local stack108 versus120bytes. Restoring only pointers173FC/1743C in an in-memory v2 control reproduces stock trace across all72. Counts are not cycles or deadlines; other task occupancy and IRQ arrivals remain open. No causal cut fix established.");
        setPlateComment(toAddr("0003cbc0"),
            "2026-09-13 individual-cylinder fuel follow-up: B544 RPM>=2000 tails3CD38 to clear six additive fuel terms CC88..CC9C. Below2000 with CCA0/40 set, lookup5FA58 scales protected records82BC+8*n, clamped to7635C/76360 (-0.03,+0.03); these are fuel-factor additions, not spark degrees. Native forced-enabled1999 control gives alternating +/-0.03;2000 and2500..3800 clear poisoned prior terms. Installed11D84 calls here before11D90->1DD04. Actual records/producer cadence remain unlogged.");
        setPlateComment(toAddr("00023864"),
            "2026-09-13 connected fuel follow-up: Installed ROM selector75E2B=00 explicitly zeros BEB8/BEBC/BEC0 and writes unity to all six BECC..BEE0 per-cylinder multipliers. Native fixtures with nonneutral prior terms, crank flags0/80, speed0/57 and counters0/FFFF confirm this. Earlier accounting/8220 and BEE8/E9/EA updates still execute; disabling this group does not disable B874. Other selector branches are not the installed path. See analyze_20260913_cylinder_fuel_followup.py.");
        setPlateComment(toAddr("00048d12"),
            "2026-09-13 individual-cylinder fuel follow-up: startup pointer10268 ->48D12, caller100B4. Initializes D06E/F=FF and D06C/70/72=FFFF, then48E32 sets all six D050..D064 multipliers to1. Native execution confirms unity from zero prior values. Periodic489E0->48D2C selects among48E32/48E4E/48E74/48E9A/48EC4 or holds. All five publishers contain only unity or stock763B4/B8/BC/C0 values1.05/0.9/1.025/0.95. Gates and actual vehicle pattern are not reconstructed; this is not a cut diagnosis.");
        setPlateComment(toAddr("00026e80"),
            "2026-09-13 running refresh: periodic11CF4 via11E54 calls this after1DD04 fuel composition and1CA38 six-duration publication. When1D228 returns0 (B748/80 clear), tails2705E to mark six record+06 duration-refresh requests; opposite gate to26E64. Connected native composer/selector/refresh/scheduler/device fixtures retain six positive targets and call90F8 with no920C cancellation. Early-active and pending updates preserve requests; supplied near-complete active pulses end when the revised target is already shorter than elapsed time. No complete-task deadline or physical-delivery claim.");
        setPlateComment(toAddr("000266ee"),
            "2026-09-13 connected duration-refresh consumer: record stage1 and inhibit byte+01 clear reach the+06 test. Value1 calls26E9A to recalculate record+18h, then the callback at mode descriptor+08. Running descriptor4B680 selects26C50 ->90F8 for a pending pulse. Bounded six-channel control updates effective counts4000..6000 to8000..10000 with no cancellation and clears+06. With flag0, prior pending counts remain. This is refresh, not scheduler reset; electrical events and full task timing are outside the fixture.");
        setPlateComment(toAddr("00026e64"),
            "2026-09-13 cut follow-up: Installed11958 calls this via11AB0 after1C920 crank-state production and2716C ignition mode. Getter1D228 reads B748/80, independent of C0E1. If set, tail2705E requests duration refresh in all six injector record+06 bytes. Consumer263EE/266EE ->26E9A ->mode callback updates durations; this is NOT a scheduler reset or direct cut. Native connected fixtures at125 logged demand RPM/ECT pairs (58..62 C), four initial phase classes, clear forced stale B748/C0 on the next phase divisible by4 even with C0AC=0;4000 supplied phase calls total. Cold20 C positive controls permit ignition mode2 with refresh requests. No vehicle B748, dispatch deadline or delivery claim. See CUT_TRACE_CAPTURE_20260913.md and analyze_20260913_crank_refresh_followup.py.");
        setPlateComment(toAddr("0002705e"),
            "2026-09-13 cut follow-up: Six byte stores of1 to injector record+06: FFFFBFBE+n*28h (n0..5), finalFFFFC086. Range literal00F0 spans six40-byte records. Called by26E64 when B748/80 is set. Flag requests duration refresh:263EE/266EE reads it in enabled stage1, calls26E9A and the selected mode callback. Running pending-pulse positive control reaches26C50 ->90F8 for all six, refreshes durations and clears flags without cancellation. Initial reset terminology was incorrect; no direct cut or WB/lean RAM overlap established.");
        setPlateComment(toAddr("00009fec"),
            "2026-09-13 full-flow audit: Battery ABB4 and RPM AC00 feed native raw-u16 descriptor60998 via21B0; result stored AD5C:u16. Getter2A3C0 returns AD5C*16. Stock14V fixtures2500/2800/3000/3500 RPM yield752/713/688/624 timer counts; not a measured battery trace.  Offline cuttrace follow-up20260913 executes native21B0/27D0/26B0 at125 logged open-plate/high-demand RPM/battery points, instead of modeled dwell interpolation. No zero requested dwell found. Quantized held inputs and device counter fixtures are not actual coil charging or deadline measurements; see logs/20260913_ignition_followup_review.json.");
        setPlateComment(toAddr("0003d824"),
            "2026-09-13 bounded cut follow-up: reads B544 RPM; RPM>=2000 tails3D980 to clear six CCC8..CCDC offsets regardless ofCCE0/40. Below2000 and enabled, copies six protected float records82EC+8*n via24C0 clamped to77F7C/80 (-5,+5deg). Native execution with deliberately distinct prior99deg offsets and forced enable verifies inclusive2000 clearing through3800. Installed11E20 points here, before final composer11E30->279CC. This is not proof of live producer timing or a cause of the cut.");
        setPlateComment(toAddr("0004f1c4"),
            "2026-09-13 cuttrace timing visibility: this conversion reads only C0EC final timing element0, not six-cylinder mean. Standard P10 separately uses callback31684 via parameter0011; native execution with distinctC0EC..C100 values confirms P10 follows onlyC0EC. The ordinary CCC8 correction producer clears atRPM>=2000; actual final five other angles and physical spark remain unlogged.");
        setPlateComment(toAddr("0000d156"),
            "2026-09-12 scheduler dependency: CF58/CF7E call3A28(task5/task6); failed activation routes here instead of queueingphase viaD0D0. Increments saturating byte at B007+taskID: B00C(task5), B00D(task6). Those counters are computed writes and absent from direct destination xrefs. D0D0/D106 use two longword slots per12-byte record fromAFEC, with independent producer/consumerbyteindices. Static path establishes a way missed scheduling can lose phase work; no overload occurrence or timing breach is proven from captured log. Cut-trace logger E535 reads B00C and E536 reads B00D as distinct uint8 values. Both saturate at255; compare with a start-of-run baseline. Native SSM A8 read-only exchanges verified20260913; no new counter or runtime patch was installed. Cuttrace 20260913_143625: B00C=B00D=0 in all1590 rows, including repeated user-confirmed loaded cuts. Capture starts at944RPM with zero counters and ends in engine stop; no task5/task6 activation losses recorded. This narrows overload-by-failed-activation but does not prove all deadlines, phase inputs or hardware outputs. See CUT_TRACE_CAPTURE_20260913.md.");
        ...
        setPlateComment(toAddr("0003192a"),
            "SSM P48 / parameter003C: native258C encodes C8C8 actual bank0 cam angle with scale1 and bias-50; display byte-50 degrees. Bank0 matches upstream Right label. Capability14 at7BDB3 supports this callback. Verified native callback and complete AVCS profile exchange on main/v2/captured. AVCSREPAIR1 20260913 records Right=0 in all268 moving/pedal>=30/RPM2500..3500 samples while Bank0 C91C output and P52 B098 current are nonzero in most. C8C8 is post-learned-offset/clamped; targets, raw capture and offset8264 are unlogged. This is not proof of a stuck physical solenoid or the cause of the persisting cut.");
        setPlateComment(toAddr("00027090"),
            "Native spark inhibit publisher: CD50/80 or CE28/01 forces C0DC=FFFF; otherwise six D94C/D94D configured bits map into duplicated12-slot masks. Independent of injector word B744. Existing ignition permission/device native tests cover this path. AVCSREPAIR1 20260913 records B744=0 during the user-confirmed loaded cut, but does not log C0DC/C0E1/C290 or coil timer outputs; no hardware-firing conclusion follows from B744 or P10 alone.");
        setPlateComment(toAddr("00027330"),
            "Native stopped/timeout ignition-mode reset. 1A256 reads B52C/80; when set this routine writes C0E1=0 and C0E3|40, and updates C0E2/80 from 7B27A and coolant75FF0. Read back from stock via MCP 20260913; caller117E4 remains stock in repairedv2. B52C/80 is published from AC0C by1A16E and cleared by19F9C. 2716C is the separate phase-task running-mode update. These states are not in AVCSREPAIR1; do not infer this reset occurred from the loaded cut.");
        ...
        setPlateComment(toAddr("0002a262"),
            "2026-09-13 full-flow audit: Returns ((C0E1!=0 ? C0DC : FFFF) | C290). Separate from injector B744. 27090 maps D94C upper2/D94D lower4 into six bits and duplicates them at+6 for both logical phase halves. Cuttrace 20260913_143625: all247 moving/pedal>=30/RPM>=2500 samples have C0DC=0,C0E1=2,C290=0FC0, so sampled primary six slots remain enabled. User confirms repeated hard cut. All125 such samples with plate>=80 also have injector B744=0. These software gates do not prove physical spark or downstream timer delivery; source/report in CUT_TRACE_CAPTURE_20260913.md.");
