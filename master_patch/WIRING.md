...
based on a 1.00 kOhm internal ECU pull-up assumption. Connect HT-010206 pin 1 to
...
1% resistor between B3-4 and B3-5 and record the loaded voltage. A 1.00 kOhm
pull-up produces a loaded voltage approximately 50.0% of the unloaded voltage
(about 2.50 V for 5.00 V unloaded). Remove the test resistor before connecting
