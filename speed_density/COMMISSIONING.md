...
2. Confirm `verify_speed_density.py` reports the generated Subaru checksum valid.
   Any later RomRaider edit must be saved with a corrected checksum and audited
   against a disposable working copy.
...
- AVLS requested and committed state, especially through the fixed 3000–3200
  RPM hysteresis region;
