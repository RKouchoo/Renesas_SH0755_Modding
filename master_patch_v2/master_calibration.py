...
STI_550CC_FLOW_RAW = 3266.66727       # ~552.47 cc/min display
STI_550CC_LATENCY_RAW = (11152, 5952, 3920, 2736, 1520) # 0.00025 ms units (2.788, 1.488, 0.980, 0.684, 0.380 ms)
...
def sti_550cc_injector_calibration() -> tuple[float, tuple[int, ...], float]:
    """Hardcoded 550cc (Subaru 16611AA510) injector calibration in D2WD units."""
    return STI_550CC_FLOW_RAW, STI_550CC_LATENCY_RAW, 552.47
...
def apply_calibration(rom: bytearray, reference: bytes) -> dict[str, tuple[int, bytes]]:
    ...
    # 550cc (Subaru 16611AA510) injector calibration in D2WD native units.
    flow_raw, latency_raw, _ = sti_550cc_injector_calibration()
    stock_flow_raw = struct.unpack_from(">f", reference, INJECTOR_FLOW_ADDR)[0]
    injector_ratio = flow_raw / stock_flow_raw
