...
| 5 | Replace MAF logic with MAFless Speed Density. | *Integrated development patch built* — final airflow uses committed-AVLS-state low/high-lift VE tables over their real 0..3200 and 3000..7500 RPM ranges, with retained post-intercooler IAT correction and no MAF fallback. Raw MAF conversion/filter/diagnostic paths and P0102/P0103 are bypassed; the ADC remains live for the external-wideband input. Invalid running data selects a fixed 500 g/s high-load fail-safe; exact zero RPM writes zero. See [avls_ve/README.md](avls_ve/README.md) for the dual-VE component and [master_patch/README.md](master_patch/README.md) for the integrated image. |
...
| [avls_ve/D2WD610H_AVLS_dual_ve_patch.xml](avls_ve/D2WD610H_AVLS_dual_ve_patch.xml) | Generated standalone SD definition with committed-state low/high-lift VE tables and predictable 3200/3000 RPM AVLS selection. |
| [master_patch/D2WD610H_master_patch.xml](master_patch/D2WD610H_master_patch.xml) | Focused self-contained metric master definition: active timing/KCA identities, fuel/injectors, AVLS, SD/VE, exact Omni MAP, boost, and external-wideband transfer/range; obsolete MAF/O2/diagnostic and dormant timing entries removed. |
