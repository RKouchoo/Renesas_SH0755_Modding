...
| 5 | Replace MAF logic with MAFless Speed Density. | *Integrated development patch built* — final airflow is an always-on RomRaider-editable 13x17 MAP/RPM VE model with retained post-intercooler IAT correction and no MAF fallback. Raw MAF conversion/filter/diagnostic paths and P0102/P0103 are bypassed; the ADC remains live for the external-wideband input. Invalid running data selects a fixed 500 g/s high-load fail-safe; exact zero RPM writes zero. See [speed_density/README.md](speed_density/README.md) for the component and [master_patch/README.md](master_patch/README.md) for the integrated image. |
