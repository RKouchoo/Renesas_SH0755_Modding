...
The rolling [D2WD610H_master_patch.bin](../../../master_patch/D2WD610H_master_patch.bin)
...
- [Deterministic builder](../../../master_patch/build_master_patch.py) and [calibration source](../../../master_patch/master_calibration.py).
...
[Historical replay support](../../../tools/analysis/historical_roms.py) reads the old 10:30 ROM from
