...
calibration endpoints; see [the existing MAP calibration notes](../../../master_patch/CALIBRATION.md).
...
```sh
python3 tools/analysis/analyze_sd_fallback.py --output /tmp/d2wd-sd-fallback.json
```
