...
```sh
python3 tools/analysis/analyze_transient_components.py --output /tmp/d2wd-transient-components.json
```
...
The subsequent [comparison script](../../../tools/analysis/compare_transient_remedies.py) executes
...
```sh
python3 tools/analysis/compare_transient_remedies.py --output /tmp/d2wd-transient-remedies.json
```
