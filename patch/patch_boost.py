...
*** PREREQUISITE for proportional correction: fit the EJ255 (turbo) MAP sensor and rescale
table 0x72810 so 0xFFFFABC4 reads real boost. Default Kp=0 is the conservative commissioning
calibration. Bench-prove the built-in hard fuel cut and retain a mechanical boost fallback. ***
